...
<html>
	...
	<head>
		...
		<style type="text/css">
			...
			.headeruserface {
				background-image: url('${ctx }/static/Resources/images/logo.png');
				width: 40px;
				height: 40px;
				background-color: white;
			...
			<ul class="ulleftmenu" style="border-right: 1px solid #ddd;">
				...
				<li class="limenuitem">
					...
					<ul class="ulleftsubitems">
						<a href="${ctx }/type/Type" target="right">
							<li>分类管理</li>
						</a>
						<a href="${ctx }/inventory.jsp" target="right">
							<li>库存管理</li>
						</a>
						<a href="${ctx }/inbound.jsp" target="right">
							<li>入库管理</li>
						</a>
						<a href="${ctx }/warning.jsp" target="right">
							<li>预警信息设置</li>
						</a>
						<a href="${ctx }/outBoud.jsp" target="right">
							<li>出库管理</li>
						</a>
						<a href="${ctx }/user/User" target="right">
							<li>用户管理</li>
						</a>
						<a href="${ctx }/updatePwd.jsp" target="right"><li >修改密码</li></a>
					</ul>
				</li>
			</ul>
			<div style="position: absolute; left: 191px; right: 20px; ">
				<iframe src="${ctx }/type/Type" scrolling="no"  width="100%" height="1200" name="right" border="none"></iframe>
			</div>
		</div>
